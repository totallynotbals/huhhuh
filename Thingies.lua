task.wait(0.5)
    ...
    game.workspace.FriendlyNPCs["Quest Giver"]:Destroy()
        ...
        task.wait(1.7)
        local A_1 = game:GetService("Workspace").FriendlyNPCs["NamekianShip"]
        local Event = game:GetService("Players").LocalPlayer.Backpack.ServerTraits.ChatStart
        Event:FireServer(A_1)
        task.wait(1)
        local A_1 = game:GetService("Workspace").FriendlyNPCs["Trunks [Future]"]
        local Event = game:GetService("Players").LocalPlayer.Backpack.ServerTraits.ChatStart
        Event:FireServer(A_1)
        task.wait(0.5)
        local A_1 = {
        ...
        Event:FireServer(A_1)
        task.wait(1)
        A_1 = game:GetService("Workspace").FriendlyNPCs.TimeMachine
        local Event = game:GetService("Players").LocalPlayer.Backpack.ServerTraits.ChatStart
        Event:FireServer(A_1)
        task.wait(1)
        local A_1 = game:GetService("Workspace").FriendlyNPCs["Bulma"]
        local Event = game:GetService("Players").LocalPlayer.Backpack.ServerTraits.ChatStart
        Event:FireServer(A_1)
        task.wait(0.5)
        local A_1 = {
        ...
        Event:FireServer(A_1)
        task.wait(1)
        A_1 = game:GetService("Workspace").FriendlyNPCs.SpaceShip
        local Event = game:GetService("Players").LocalPlayer.Backpack.ServerTraits.ChatStart
        Event:FireServer(A_1)
        task.wait(1)
